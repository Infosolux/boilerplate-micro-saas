...
export const createCheckoutSession = async ({ userId, userEmail, priceId, userStripeSubscriptionId }: CreatecheckoutSessionProps) => {
  try {
    ...
    const session = await stripe.billingPortal.sessions.create({
      ...
      flow_data: {
        ...
        after_completion: {
          ...
          redirect: {
            return_url:
              `${config.appUrl}/app/settings/billing?success=true`,
          },
        },
